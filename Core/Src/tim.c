...
void MX_TIM1_Init(void)
{
  ...
  htim1.Instance = TIM1;
  htim1.Init.Prescaler = 2249;
  htim1.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim1.Init.Period = 153;
...
void setPitch(int val) {
  ...
  switch (val) {
    ...
    case(3): new_period = 182; break;
    case(4): new_period = 153; break;
    case(5): new_period = 136; break;
    case(6): new_period = 121; break;
    case(7): new_period = 115; break;
    case(8): new_period = 102; break;
  }
  htim1.Instance->CCR1 = new_period/2;
  htim1.Instance->ARR = new_period;
}
